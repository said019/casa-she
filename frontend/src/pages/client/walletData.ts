...
export const walletActivity = [
  { id: '1', label: 'Clase Barre Studio', points: 10, date: 'Hoy', type: 'earned' },
  { id: '2', label: 'Clase Pilates Mat', points: 10, date: 'Ayer', type: 'earned' },
  { id: '3', label: 'Calcetines', points: -200, date: '3 Ene', type: 'redeemed' },
  { id: '4', label: 'Bono de bienvenida', points: 50, date: '1 Ene', type: 'bonus' },
];
