...
async function runStartupMigrations(): Promise<void> {
  ...
  try {
    ...
    // Migration 031: política de cancelación. El catálogo de class_types y plans
    // no-Casa-Shé (BMB/Reformer/Pole/Twerk/etc.) fue eliminado del seed en julio 2026;
    // el catálogo real de Casa Shé lo gestiona el bloque CS_TYPES/CS_PLANS más abajo.
    try {
        ...
        console.log('Migration 031: politica de cancelacion sembrada.');
