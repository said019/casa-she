...
-- Categoría de clase (migración 019_membership_categories)
DO $$ BEGIN
...
CREATE TABLE IF NOT EXISTS plans (
    ...
    reformer_credits INTEGER,
    multi_credits    INTEGER,
...
CREATE TABLE IF NOT EXISTS memberships (
    ...
    reformer_remaining   INTEGER,
    multi_remaining      INTEGER,
    start_date           DATE,
    end_date             DATE,
...
CREATE TABLE IF NOT EXISTS class_types (
    ...
    category         class_category NOT NULL DEFAULT 'multi',
...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    consumed_category    class_category,
...
-- ============================================================
-- SECCIÓN 17: POS + CAJA (Migration 032)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS sales (
    ...
    facility_id    UUID REFERENCES facilities(id),
    shift_id       UUID,  -- FK to cash_shifts added after that table
    created_at     TIMESTAMPTZ DEFAULT NOW(),
    updated_at     TIMESTAMPTZ DEFAULT NOW()
);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_one_open_shift_per_facility
    ON cash_shifts(facility_id) WHERE status = 'open';
...
ALTER TABLE payments ADD COLUMN IF NOT EXISTS shift_id UUID REFERENCES cash_shifts(id);
ALTER TABLE users    ADD COLUMN IF NOT EXISTS default_facility_id UUID REFERENCES facilities(id);
...
-- Tablas creadas: ~41
-- Migraciones integradas: 18 (incl. 032 POS + caja)
-- ============================================================
DO $$
BEGIN
    ...
    RAISE NOTICE '           product_categories, products, sales, sale_items,';
    RAISE NOTICE '           cash_shifts, cash_movements.';
END $$;
